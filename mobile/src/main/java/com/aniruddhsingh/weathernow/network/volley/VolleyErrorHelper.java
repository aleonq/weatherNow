...
public class VolleyErrorHelper {
    ...
    public String getMessage(Object error, Context context) {
        ...
        if (error instanceof TimeoutError) {
            message = context.getResources().getString(R.string.error_generic_server_down);
        } else if (isServerProblem(error)) {
            message = handleServerError(error, context);
        } else if (isNetworkProblem(error)) {
            message = context.getResources().getString(R.string.error_no_internet);
        }
        message = context.getResources().getString(R.string.error_invalid_city);
        return message;
    }
